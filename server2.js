                              ...
                              if(forestData!=null || forestData!=undefined){
                                        fetchAirData(latitude,longitude, function(air){
                                                  ...
                                                  if(forestData!=null || forestData!=undefined){
                                                    ...
                                                    fetchGroundWaterData(state,district,function(groundwater){

                                                            
                                                                  initiateParametes(airData,forestData,groundwater,function(obj){
...
function fetchForestData(state,callback){
  ...
  ref.on("value", function(snapshot) {
    ...
    callback({"geo":snapshot.val().geoarea,"nf":snapshot.val().noforest,"af":snapshot.val().actualforestcover,"of":snapshot.val().openforest})
...
async function fetchGroundWaterData(state,district,callback){
...
function initiateParametes(airData,forestData,groundwater,callback){
